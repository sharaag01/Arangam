...
import com.yessel.arangam.Adapters.AlphabetItem;
import com.yessel.arangam.Adapters.ArtistsAdapter;
import com.yessel.arangam.Adapters.ArtistsRecyclerViewAdapter;
import com.yessel.arangam.Adapters.SimpleDividerItemDecoration;
...
public class ArtistFragment extends Fragment implements SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener {
...
//        }
        ...
        mAdapter = new ArtistsRecyclerViewAdapter(mArtistList);
//        myDataset.clear();
...
//        mRecyclerView.setIndexBarTransparentValue((float) 0.4);
        mRecyclerView.setIndexbarMargin(8);
        mRecyclerView.setIndexbarWidth(40);
        mRecyclerView.setPreviewPadding(4);
    ...
    protected void initialiseData() {
        //Recycler view data
//        mArtistList = DataHelper.getAlphabetData();

        //Alphabet fast scroller data
        mAlphabetItems = new ArrayList<>();
        List<String> strAlphabets = new ArrayList<>();
        for (int i = 0; i < mArtistList.size(); i++) {
            String name = mArtistList.get(i).getName();
